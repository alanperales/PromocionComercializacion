...
public class Parametro {
	...
	private int PD_CodigoParametroDet;
	private int PR_CodigoParametroCab;
	...
	private int PD_EstadoElemento;
	
	public int getPD_CodigoParametroDet() {
		return PD_CodigoParametroDet;
	}
	public void setPD_CodigoParametroDet(int pD_CodigoParametroDet) {
		PD_CodigoParametroDet = pD_CodigoParametroDet;
	}
	public int getPR_CodigoParametroCab() {
		return PR_CodigoParametroCab;
	}
	public void setPR_CodigoParametroCab(int pR_CodigoParametroCab) {
	...
	public int getPD_EstadoElemento() {
		return PD_EstadoElemento;
	}
	public void setPD_EstadoElemento(int pD_EstadoElemento) {
